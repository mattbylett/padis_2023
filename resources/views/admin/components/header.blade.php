                ...
                <div class="tab-content py-4 py-lg-8 px-lg-7">
                  ...
                  <div class="tab-pane active w-lg-1000px" id="kt_app_header_menu_pages_pages">
                    ...
                    <div class="row">
                      ...
                      <!--begin:Col-->
                      <div class="col-lg-4">
                        <img src="{{asset('admin/assets/media/stock/600x600/img-82.jpg')}}" class="rounded mw-100" alt="" />
                      </div>
                      <!--end:Col-->
                    </div>
                    <!--end:Row-->
                  ...
                  <div class="tab-pane w-lg-600px" id="kt_app_header_menu_pages_account">
                    ...
                    <div class="row">
                      ...
                      <!--begin:Col-->
                      <div class="col-lg-7">
                        <img src="{{asset('admin/assets/media/stock/900x600/46.jpg')}}" class="rounded mw-100" alt="" />
                      </div>
                      <!--end:Col-->
                    </div>
                    <!--end:Row-->
                  ...
                  <div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_utilities">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-5 pe-lg-5">
                        <img src="{{asset('admin/assets/media/stock/600x600/img-84.jpg')}}" class="rounded mw-100" alt="" />
                      </div>
                      <!--end:Col-->
                    </div>
                    <!--end:Row-->
                  ...
                  <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
                    ...
                    <div class="row">
                      ...
                      <!--begin:Col-->
                      <div class="col-lg-8">
                        <img src="{{asset('admin/assets/media/stock/900x600/44.jpg')}}" class="rounded mw-100" alt="" />
                      </div>
                      <!--end:Col-->
                    </div>
                    <!--end:Row-->
                  ...
                  <div class="row g-2">
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/amazon.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/angular-icon-1.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/atica.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/beats-electronics.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/codeigniter.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/bootstrap-4.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/google-tag-manager.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/disqus.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/dribbble-icon-1.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/google-play-store.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/google-podcasts.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/figma-1.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/github.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/gitlab.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/instagram-2-1.svg')}}" class="w-25px h-25px mb-2" alt="" />
                    ...
                    <div class="col-4">
                      <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                        <img src="{{asset('admin/assets/media/svg/brand-logos/pinterest-p.svg')}}" class="w-25px h-25px mb-2" alt="" />
