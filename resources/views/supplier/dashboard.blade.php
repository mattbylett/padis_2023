									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<!--begin::Username-->
												<div class="d-flex flex-column">
													<div class="fw-bold d-flex align-items-center fs-5">{{Auth::guard('supplier')->user()->name}}
													<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span></div>
													<a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{Auth::guard('supplier')->user()->email }}</a>
												</div>
												<!--end::Username-->
											</div>
										</div>
										...
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="{{route('supplier.logout')}}" class="menu-link px-5">Sign Out</a>
										</div>
										<!--end::Menu item-->
									</div>
					...
					<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
						...
						@endif
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<h3>Welcome {{Auth::guard('supplier')->user()->name}}</h3>
									<!--begin::Row-->
