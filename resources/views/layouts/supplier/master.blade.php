...
<html lang="en">
	<!--begin::Head-->
	<head><base href=""/>
		<title>PADIS: Integration Software Solutions</title>
		<meta charset="utf-8" />
								...
								<div class="row g-5">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-success rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo1/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo2/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo6/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo3/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo8/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo10/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo11/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo4/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo27/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo20/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo25/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo30/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo23/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo29/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo14/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo24/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo26/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo7/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo22/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo28/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo19/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo9/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo13/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo16/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo18/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo21/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo12/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo17/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo15/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
											<div class="overlay-wrapper">
												<img src="{{asset('admin/assets/media/preview/demos/demo5/light-ltr.png')}}" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
