                ...
                load_node: function (t, i) {
                    ...
                    return (
                        ...
                        this._load_node(
                            t,
                            function (e) {
                                ((t = this._model.data[t.id]).state.loading =
                                    !1),
                                    (t.state.loaded = e),
                                ...
                                if (
                                    ...
                                    for (
                                        ...
                                        f[p.parents[r]].children_d =
                                            f[p.parents[r]].children_d.concat(
                                                l
                                            );
                                    a = {
                                        cnt: u,
