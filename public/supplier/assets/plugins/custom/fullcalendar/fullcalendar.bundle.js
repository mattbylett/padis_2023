...
var FullCalendar = (function (e) {
    ...
    ***************************************************************************** */ var t =
            ...
            return (
                (e.prototype.splitProps = function (e) {
                    var t = this,
                        ...
                        u = {};
                    for (var c in ((this.eventUiBuilders = St(
                        n,
                        function (e, n) {
    ...
    var Lo = (function (e) {
        ...
        return (
            ...
            (t.prototype.shouldComponentUpdate = function (e, t) {
                return (
                    this.debug &&
                        console.log(xt(e, this.props), xt(t, this.state)),
            ...
            function t() {
                ...
                return (
                    ...
                    (t.handleRootEl = function (e) {
                        Vo(t.rootElRef, e),
                            t.props.elRef && Vo(t.props.elRef, e);
                    }),
                    t
                );
            }
            ...
            !(
                ...
                !(function (e, t, n, o) {
                    ...
                    for (var m in u) {
                        var y = u[m],
                            ...
                            b = c[y.defId],
                            S = l[y.defId];
                        if (!Aa(b.constraints, E, d, e.businessHours, t))
                            return !1;
                        ...
                        for (
                            var C = i.eventStore, k = 0, R = b.allows;
                            k < R.length;
                            k++
                        ) {
                            var _ = R[k],
                ...
                !(
                    ...
                    !(function (e, t, n, o) {
                        ...
                        o && (c = o(c));
                        if (!Aa(c.constraints, u, i, e.businessHours, t))
                            return !1;
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return Co(
                    ...
                    Boolean(!v && p.length) &&
                        Co.apply(void 0, o(["thead", g], p)),
                    Boolean(!v && f.length) &&
                        Co.apply(void 0, o(["tbody", g], f)),
                    Boolean(!v && h.length) &&
                        Co.apply(void 0, o(["tfoot", g], h)),
    ...
    function ps(e) {
        return (
            e.event.title &&
            Co("div", { className: "fc-event-title" }, e.event.title)
        );
    }
    var fs = function (e) {
        return Co(Ao.Consumer, null, function (t) {
        ...
        ks = (function () {
            function e(e) {
                ...
                (this.subjectEl = null),
                    ...
                    1 === (xs += 1) &&
                        window.addEventListener("touchmove", Rs, {
                            passive: !1,
                        });
            }
            return (
                (e.prototype.destroy = function () {
                    this.containerEl.removeEventListener(
                        ...
                        (xs -= 1) ||
                            window.removeEventListener("touchmove", Rs, {
                                passive: !1,
                            });
                }),
                (e.prototype.tryStart = function (e) {
                    ...
                    return (
                        !(
                            !t ||
                            (this.handleSelector && !be(n, this.handleSelector))
                        ) &&
                        ((this.subjectEl = t),
                        (this.isDragging = !0),
                        (this.wasTouchScroll = !1),
        ...
        function t(n) {
            ...
            (o.subjectEl = null),
                ...
                (o.handlePointerDown = function (e) {
                    ...
                    var d =
                        r.isValidSegDownEl(t) && !be(t, ".fc-event-resizer");
                    i.setIgnoreMove(!d),
                        (o.isDragging =
                            d &&
    ...
    var au = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.buildTimeColsModel = qt(su)), (t.buildSlatMetas = qt(iu)), t
            );
        }
        return (
            n(t, e),
